/*
 * File added by J. Daniel Garcia. Universidad Carlos III de Madrid.
 */

// This modification avoid linker issues with gcc-10 by defining global veriables
// in one object file and making them extern in the corresponding header.
